...
(function (window) {
    ...
    legend.prototype.extend({
        ...
        render: function () {
            ...
            var itemList = legendGroup.selectAll('.xc-legend-item').data(_this.legendSeries);
        ...
        ready: function () {
            ...
            var nameList = multiple ? this.legendSeries.map(function (serie) {
                return serie.name;
            }) : [];
     ...
     */
    function calcTextWidth(fontSize,offsetWidth){
